...
from tvod.constants import TVOD_NAME, TVOD_VERSION, TVOD_VERSION_NAME
from tvod.helpers import project_path


class Commands(click.MultiCommand):
    def __call__(self, *args, **kwargs):
        version = f'v{TVOD_VERSION} [{TVOD_VERSION_NAME}]'
    ...
    def commands_path(self):
        return os.path.join(project_path, 'tvod/commands')
    ...
    def get_command(self, ctx, command):
        ...
        command_class = importlib.import_module(f'tvod.commands.{command}')
